...
class SparePartsSubscriptionTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $plan = app('rinvex.subscriptions.plan')->create([
            ...
            'slug' => 'spare-parts-distributor-silver',
        ...
        $plan->features()->saveMany([
            ...
            new PlanFeature(['name' => ['en' => 'Number of Spare Parts', 'ar' => 'عدد قطع الغيار'], 'value' => 'Unlimited', 'sort_order' => 3, 'resettable_period' => 1, 'resettable_interval' => 'month']),
            new PlanFeature(['name' => ['en' => 'Photos Per Spare Parts', 'ar' => 'صور لكل قطع الغيار'], 'value' => 2, 'sort_order' => 4, 'resettable_period' => 1, 'resettable_interval' => 'month']),
        ...
        $plan = app('rinvex.subscriptions.plan')->create([
            ...
            'slug' => 'spare-parts-distributor-gold',
        ...
        // Create multiple plan features at once
        $plan->features()->saveMany([
            new PlanFeature(['name' => ['en' => 'Min Cost', 'ar' => 'اقل تكلفة'], 'value' => 5500, 'sort_order' => 1, 'resettable_period' => 1, 'resettable_interval' => 'month']),
            new PlanFeature(['name' => ['en' => 'Max Cost', 'ar' => 'اعلى تكلغة'], 'value' => 7000, 'sort_order' => 2, 'resettable_period' => 1, 'resettable_interval' => 'month']),
            new PlanFeature(['name' => ['en' => 'Number of Spare Parts', 'ar' => 'عدد قطع الغيار'], 'value' => 'Unlimited', 'sort_order' => 3, 'resettable_period' => 1, 'resettable_interval' => 'month']),
            new PlanFeature(['name' => ['en' => 'Photos Per Spare Parts', 'ar' => 'صور لكل قطع الغيار'], 'value' => 3, 'sort_order' => 4, 'resettable_period' => 1, 'resettable_interval' => 'month']),
            new PlanFeature(['name' => ['en' => 'User Dashboard', 'ar' => 'لوحة تحكم المستخدم'], 'value' => 'true', 'sort_order' => 7, 'resettable_period' => 1, 'resettable_interval' => 'month']),
            new PlanFeature(['name' => ['en' => 'Live Chat', 'ar' => 'دردشة مباشرة'], 'value' => 'true', 'sort_order' => 8, 'resettable_period' => 1, 'resettable_interval' => 'month']),
        ...
        $plan = app('rinvex.subscriptions.plan')->create([
            ...
            'slug' => 'spare-parts-distributor-platinum',
        ...
        // Create multiple plan features at once
        $plan->features()->saveMany([
            new PlanFeature(['name' => ['en' => 'Min Cost', 'ar' => 'اقل تكلفة'], 'value' => 10000, 'sort_order' => 1, 'resettable_period' => 1, 'resettable_interval' => 'month']),
            new PlanFeature(['name' => ['en' => 'Max Cost', 'ar' => 'اعلى تكلغة'], 'value' => 13500, 'sort_order' => 2, 'resettable_period' => 1, 'resettable_interval' => 'month']),
            new PlanFeature(['name' => ['en' => 'Number of Spare Parts', 'ar' => 'عدد قطع الغيار'], 'value' => 'Unlimited', 'sort_order' => 3, 'resettable_period' => 1, 'resettable_interval' => 'month']),
            new PlanFeature(['name' => ['en' => 'Photos Per Spare Parts', 'ar' => 'صور لكل قطع الغيار'], 'value' => 4, 'sort_order' => 4, 'resettable_period' => 1, 'resettable_interval' => 'month']),
            new PlanFeature(['name' => ['en' => 'User Dashboard', 'ar' => 'لوحة تحكم المستخدم'], 'value' => 'true', 'sort_order' => 7, 'resettable_period' => 1, 'resettable_interval' => 'month']),
            new PlanFeature(['name' => ['en' => 'Live Chat', 'ar' => 'دردشة مباشرة'], 'value' => 'true', 'sort_order' => 8, 'resettable_period' => 1, 'resettable_interval' => 'month']),
            new PlanFeature(['name' => ['en' => 'Account Manager', 'ar' => 'مدير حساب مخصص'], 'value' => 'true', 'sort_order' => 10, 'resettable_period' => 1, 'resettable_interval' => 'month']),
