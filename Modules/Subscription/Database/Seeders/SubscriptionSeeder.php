...
class SubscriptionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $plan->features()->saveMany([
            ...
            new PlanFeature(['name' => ['en' => 'Max Cost', 'ar' => 'اعلى تكلغة'], 'value' => 100, 'sort_order' => 2]),
            new PlanFeature(['name' => ['en' => 'Number of Listing', 'ar' => 'عدد القوائم'], 'value' => 1, 'sort_order' => 3]),
            new PlanFeature(['name' => ['en' => 'Photos Per Listing', 'ar' => 'صور لكل قائمة'], 'value' => 6, 'sort_order' => 4]),
            new PlanFeature(['name' => ['en' => 'Video Per listing', 'ar' => 'فيديو لكل قائمة'], 'value' => 'false', 'sort_order' => 5]),
            new PlanFeature(['name' => ['en' => 'Listing in Arabic and English', 'ar' => 'الإدراج باللغتين العربية والإنجليزية'], 'value' => 'true', 'sort_order' => 6]),
            new PlanFeature(['name' => ['en' => 'User Dashboard', 'ar' => 'لوحة تحكم المستخدم'], 'value' => 'true', 'sort_order' => 7]),
            new PlanFeature(['name' => ['en' => 'Live Chat', 'ar' => 'دردشة مباشرة'], 'value' => 'true', 'sort_order' => 8]),
            new PlanFeature(['name' => ['en' => 'Bulk Import', 'ar' => 'استيراد بالجملة'], 'value' => 'false', 'sort_order' => 9]),
            new PlanFeature(['name' => ['en' => 'Dedicated Account Manager', 'ar' => 'مدير حساب مخصص'], 'value' => '1 Hour Per Month', 'sort_order' => 10]),
            new PlanFeature(['name' => ['en' => 'Upgrade feature listing', 'ar' => 'ترقية قائمة الميزات'], 'value' => 'false', 'sort_order' => 11]),
            new PlanFeature(['name' => ['en' => 'Having discount on opening branded page', 'ar' => 'الحصول على خصم على فتح الصفحة ذات العلامات التجارية'], 'value' => 'false', 'sort_order' => 12]),
            new PlanFeature(['name' => ['en' => 'Subscription for branded page', 'ar' => 'الاشتراك في الصفحة ذات العلامات التجارية'], 'value' => 'false', 'sort_order' => 13]),
            new PlanFeature(['name' => ['en' => 'Machines to be boosted in the top', 'ar' => 'يتم تعزيز الآلات في الأعلى'], 'value' => 0, 'sort_order' => 14]),
            new PlanFeature(['name' => ['en' => 'Email Marketing', 'ar' => 'التسويق عبر البريد الإلكتروني'], 'value' => 'false', 'sort_order' => 15]),
        ]);
        ...
        $plan->features()->saveMany([
            ...
            new PlanFeature(['name' => ['en' => 'Max Cost', 'ar' => 'اعلى تكلغة'], 'value' => 560, 'sort_order' => 2]),
            new PlanFeature(['name' => ['en' => 'Number of Listing', 'ar' => 'عدد القوائم'], 'value' => 5, 'sort_order' => 3]),
            new PlanFeature(['name' => ['en' => 'Photos Per Listing', 'ar' => 'صور لكل قائمة'], 'value' => 11, 'sort_order' => 4]),
            new PlanFeature(['name' => ['en' => 'Video Per listing', 'ar' => 'فيديو لكل قائمة'], 'value' => 1, 'sort_order' => 5]),
            new PlanFeature(['name' => ['en' => 'Listing in Arabic and English', 'ar' => 'الإدراج باللغتين العربية والإنجليزية'], 'value' => 'true', 'sort_order' => 6]),
            new PlanFeature(['name' => ['en' => 'User Dashboard', 'ar' => 'لوحة تحكم المستخدم'], 'value' => 'true', 'sort_order' => 7]),
            new PlanFeature(['name' => ['en' => 'Live Chat', 'ar' => 'دردشة مباشرة'], 'value' => 'true', 'sort_order' => 8]),
            new PlanFeature(['name' => ['en' => 'Bulk Import', 'ar' => 'استيراد بالجملة'], 'value' => 'false', 'sort_order' => 9]),
            new PlanFeature(['name' => ['en' => 'Dedicated Account Manager', 'ar' => 'مدير حساب مخصص'], 'value' => 'true', 'sort_order' => 10]),
            new PlanFeature(['name' => ['en' => 'Upgrade feature listing', 'ar' => 'ترقية قائمة الميزات'], 'value' => 'true', 'sort_order' => 11]),
            new PlanFeature(['name' => ['en' => 'Having discount on opening branded page', 'ar' => 'الحصول على خصم على فتح الصفحة ذات العلامات التجارية'], 'value' => '10%', 'sort_order' => 12]),
            new PlanFeature(['name' => ['en' => 'Subscription for branded page', 'ar' => 'الاشتراك في الصفحة ذات العلامات التجارية'], 'value' => 'true', 'sort_order' => 13]),
            new PlanFeature(['name' => ['en' => 'Machines to be boosted in the top', 'ar' => 'يتم تعزيز الآلات في الأعلى'], 'value' => 1, 'sort_order' => 14]),
            new PlanFeature(['name' => ['en' => 'Email Marketing', 'ar' => 'التسويق عبر البريد الإلكتروني'], 'value' => 'true', 'sort_order' => 15]),
        ]);
        ...
        $plan->features()->saveMany([
            new PlanFeature(['name' => ['en' => 'Min Cost', 'ar' => 'اقل تكلفة'], 'value' => 'Please Contact Us', 'sort_order' => 1]),
            new PlanFeature(['name' => ['en' => 'Max Cost', 'ar' => 'اعلى تكلغة'], 'value' => 'Please Contact Us', 'sort_order' => 2]),
            new PlanFeature(['name' => ['en' => 'Number of Listing', 'ar' => 'عدد القوائم'], 'value' => 'More than 10', 'sort_order' => 3]),
            new PlanFeature(['name' => ['en' => 'Photos Per Listing', 'ar' => 'صور لكل قائمة'], 'value' => 50, 'sort_order' => 4]),
            new PlanFeature(['name' => ['en' => 'Video Per listing', 'ar' => 'فيديو لكل قائمة'], 'value' => 3, 'sort_order' => 5]),
            new PlanFeature(['name' => ['en' => 'Listing in Arabic and English', 'ar' => 'الإدراج باللغتين العربية والإنجليزية'], 'value' => 'true', 'sort_order' => 6]),
            new PlanFeature(['name' => ['en' => 'User Dashboard', 'ar' => 'لوحة تحكم المستخدم'], 'value' => 'true', 'sort_order' => 7]),
            new PlanFeature(['name' => ['en' => 'Live Chat', 'ar' => 'دردشة مباشرة'], 'value' => 'true', 'sort_order' => 8]),
            new PlanFeature(['name' => ['en' => 'Bulk Import', 'ar' => 'استيراد بالجملة'], 'value' => 'true', 'sort_order' => 9]),
            new PlanFeature(['name' => ['en' => 'Dedicated Account Manager', 'ar' => 'مدير حساب مخصص'], 'value' => 'true', 'sort_order' => 10]),
            new PlanFeature(['name' => ['en' => 'Upgrade feature listing', 'ar' => 'ترقية قائمة الميزات'], 'value' => 'true', 'sort_order' => 11]),
            new PlanFeature(['name' => ['en' => 'Having discount on opening branded page', 'ar' => 'الحصول على خصم على فتح الصفحة ذات العلامات التجارية'], 'value' => '20%', 'sort_order' => 12]),
            new PlanFeature(['name' => ['en' => 'Subscription for branded page', 'ar' => 'الاشتراك في الصفحة ذات العلامات التجارية'], 'value' => 'true', 'sort_order' => 13]),
            new PlanFeature(['name' => ['en' => 'Machines to be boosted in the top', 'ar' => 'يتم تعزيز الآلات في الأعلى'], 'value' => 3, 'sort_order' => 14]),
            new PlanFeature(['name' => ['en' => 'Email Marketing', 'ar' => 'التسويق عبر البريد الإلكتروني'], 'value' => 'true', 'sort_order' => 15]),
        ]);
